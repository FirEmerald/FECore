...
import com.firemerald.fecore.codec.StringRepresentableCodec;
...
public class SlotRanges {
    private static final List<SlotRange> SLOTS = Util.make(new ArrayList<>(), p_333664_ -> {
        ...
        addSlots(p_333664_, "armor.*", i, j, k, l);
    ...
    public static final Codec<SlotRange> CODEC = StringRepresentableCodec.fromValues(() -> SLOTS.toArray(new SlotRange[0]));
    private static final Function<String, SlotRange> NAME_LOOKUP = StringRepresentableCodec.createNameLookup(SLOTS.toArray(new SlotRange[0]), p_332645_ -> p_332645_);
