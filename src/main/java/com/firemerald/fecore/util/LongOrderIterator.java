...
public class LongOrderIterator implements Iterator<long[]>
{
	private final long[] values, current;
	private final boolean[] grabbed;
	private final int[] iterations;
	private boolean first = true;

	@SafeVarargs
	public LongOrderIterator(long... values)
	{
		this.values = values;
		this.current = new long[values.length];
