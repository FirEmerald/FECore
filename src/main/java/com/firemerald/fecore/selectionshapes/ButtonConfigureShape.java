...
public class ButtonConfigureShape extends Button
{
	...
	{
		super(x, y, width, height, new TranslatableComponent("gui.shape.configure", getShape.get().getLocalizedName()), null);
	...
	{
		this.displayString = new TranslatableComponent("gui.shape.configure", shape.getLocalizedName());
	}
}